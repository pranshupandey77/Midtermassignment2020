...
include 'config.php';
  ...
  $sql =  "SELECT * FROM details where enrollment=$enrollment";
 ...
 ?>
<form action="update.php?enrollment=<?php echo $enrollment; ?>" method="POST">

   <label for="uenrollment"><b>Name</b></label>
   <input type="text" value="<?php echo $row['enrollment']; ?>" name="uenrollment" required id="idenrollment"><br>
